...
class VoiceReminderService {
  ...
  Future<void> init() async {
    ...
    _voiceService =
        VoiceService(); // Lazily mount to ensure UI contexts have bound
  ...
  Future<void> scheduleVoiceReminder({
    ...
    final String tamilText =
        customMessage ?? "அக்கா, $medicineName சாப்பிட மறந்துவிடாதீர்கள்!";
    ...
    await _flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      notificationDetails: const NotificationDetails(
        android: AndroidNotificationDetails(
          ...
          channelDescription:
              'Smart maternal health notification routines avoiding chore hours.',
