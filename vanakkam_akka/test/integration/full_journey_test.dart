...
import 'package:arogya/main.dart'; // Or explicitly your App binding
...
void main() {
  ...
  */
  testWidgets('Full User Journey E2E Integrity Pipeline', (
    WidgetTester tester,
  ) async {
    // Step 1: Initialize full widget tree explicitly mapping structural routes securely
    await tester.pumpWidget(
      const ArogyaApp(),
    ); // Mocks running the unified App tree natively
