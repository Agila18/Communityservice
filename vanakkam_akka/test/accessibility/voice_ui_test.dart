...
import 'package:arogya/features/screening/voice_chat_ui.dart';
import 'package:arogya/features/reminders/reminder_home.dart';
import 'package:arogya/features/onboarding/otp_login.dart';

void main() {
  group('Accessibility & Voice Interface Tests - WCAG AA Standards', () {
    testWidgets(
      'VoiceChatUI should be fully navigable via ScreenReaders and implicitly Dictate',
      (WidgetTester tester) async {
        ...
        expect(
          ...
          reason: "Voice target must meet WCAG 48px minimum",
        );
        expect(
          buttonRect.height,
          greaterThanOrEqualTo(48.0),
    ...
    testWidgets(
      'OTP Login implicitly loads requiring absolutely zero manual typing through TTS injections',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Reminders map explicitly enforcing huge icon heuristics avoiding text-only arrays',
      (WidgetTester tester) async {
